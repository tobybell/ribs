...
function copy$3(out: Mat4, a: Mat4) {
  out[0] = a[0];
  out[1] = a[1];
  out[2] = a[2];
  out[3] = a[3];
...
function identity$3(out: Mat4): Mat4 {
  out[0] = 1;
  out[1] = 0;
  out[2] = 0;
  out[3] = 0;
...
function transpose$2(out: Mat4, a: Mat4): Mat4 {
...
function invert$3(out: Mat4, a: Mat4): Mat4 | undefined {
  var a00 = a[0],
      a01 = a[1],
      a02 = a[2],
      a03 = a[3];
...
function adjoint$2(out: Mat4, a: Mat4): Mat4 {
  var a00 = a[0],
      a01 = a[1],
      a02 = a[2],
      a03 = a[3];
...
function determinant$3(a: Mat4): number {
  var a00 = a[0],
      a01 = a[1],
      a02 = a[2],
      a03 = a[3];
...
function multiply$3(out: Mat4, a: Mat4, b: Mat4): Mat4 {
  var a00 = a[0],
      a01 = a[1],
      a02 = a[2],
      a03 = a[3];
...
function translate$2(out: Mat4, a: Mat4, v: Vec3): Mat4 {
  var x = v[0],
      y = v[1],
      z = v[2];
  var a00, a01, a02, a03;
...
function scale$3(out: Mat4, a: Mat4, v: Vec3) {
  var x = v[0],
      y = v[1],
      z = v[2];
  out[0] = a[0] * x;
...
function rotate$3(out: Mat4, a: Mat4, rad: number, axis: Vec3): Mat4 | undefined {
  var x = axis[0],
      y = axis[1],
      z = axis[2];
