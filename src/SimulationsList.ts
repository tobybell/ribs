...
const simulationRow = (openTimeline: Handler<Simulation>) => (s: SimulationIndexRecord) => divr(
  style({
    fontWeight: 'bold',
    color: 'white',
    margin: '8px',
