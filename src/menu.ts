...
import { children, span, divr, style } from './div';
...
const borderOverlay = divr(style({
  position: 'absolute',
  top: '0',
  left: '0',
  width: '100%',
...
const dropdownBorderOverlay = divr(style({
  position: 'absolute',
  top: '0',
  left: '0',
  width: '100%',
...
export const menu = (contents: MenuComponent[], size = 14, dropdown = false): Menu => h => divr(style({
  padding: '4px 0',
...
export const menuSeparator = () => divr(style({
  height: '2px',
